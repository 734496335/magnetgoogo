...
install -m 0755 "$SOURCE_DIR/source-sync-alert.sh" /opt/magnet-source-sync/source-sync-alert.sh
install -m 0644 "$SOURCE_DIR/magnet-source-sync.service" /etc/systemd/system/magnet-source-sync.service
install -m 0644 "$SOURCE_DIR/magnet-source-sync-alert.service" /etc/systemd/system/magnet-source-sync-alert.service
